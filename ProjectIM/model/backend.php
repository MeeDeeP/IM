...
public function doCreateStudent($studid, $firstname, $lastname, $gender, $age, $address, $section){
    return self::CreateStudent($studid, $firstname, $lastname, $gender, $age, $address, $section);
}
