...
if(isset($_POST['updateStudent'])){
    try {
        $stmt = $conn->prepare("CALL updateStudent(:_fname, :_lname, :_gender, :_age, :_address, :_section,:_stud_id)");
    ...
    <div class="content">
        ...
        ?>
            ...
            <div class="row text-center">
                ...
                <div class="col-lg-12">
                    <input type="number" name="age"  value="<?php echo $row['age']; ?>" class="input-field" placeholder="Age">
                </div>
                <div class="col-lg-12">
                    <input type="text" name="address"  value="<?php echo $row['address']; ?>" class="input-field" placeholder="Address">
                </div>
                <div class="col-lg-12">
